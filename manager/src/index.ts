...
// devisor
import Restarter from "@devisor/restarter";
const $Restarter = !process.env.DEVISOR_HACK ? Restarter :
  require("@devisor/restarter/src/restarter") as typeof Restarter;
// end devisor
